...
@Injectable()
export class DocumentTypeConstructionService extends ServiceBase {
  headers = new Headers();
  constructor(
    private http: Http,
  ...
  updateDocumentTypeConstruction(data: DocumentTypeConstruction): Observable<DocumentTypeConstruction> {
     let response = this.http
      .put(environment.serviceUrl + `api/v1/documenttypeconstruction/${data.id}`,
